...
figure) — the exact failure modes A1 named and A2's granite-docling-2stage-258m OCR targets. None
...
page image, in the same markdown+LaTeX convention granite-docling-2stage-258m itself outputs
